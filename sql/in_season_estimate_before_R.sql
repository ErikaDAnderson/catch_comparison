-- in_season_estimate_before_R.sql
-- JP, 2024-06-25
-- Query used to pull EXTERNAL ONLY in-season estimates
-- :Start_Date and :End_Date format = MM/DD/YYYY hh:mm
-- Schema owner credentials not required

-- JP, 2026-04-01
-- Optimized with help from Claude (Anthropic AI tool)
-- Includes all gear types
-- Can filter by FA_ID for specific PFMAs, enter desired PFMA's 23,24,25 or 23
-- Can filter by gear type, enter 5,6,7 or 6
-- Enter Y for ATIP Safe data. Enter N for unfiltered data
